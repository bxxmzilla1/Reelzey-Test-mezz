                        ...
                        <div className="glass p-6 rounded-3xl flex flex-col items-center gap-4">
                            ...
                            <div className="flex flex-col md:flex-row gap-4 mt-4 w-full">
                                <button
                                    ...
                                    disabled={isLoading}
                                    className="w-full bg-blue-600 hover:bg-blue-500 text-white font-semibold px-6 py-3 rounded-xl flex items-center justify-center gap-2 transition-all active:scale-95 disabled:bg-gray-800 disabled:text-gray-500 disabled:cursor-not-allowed"
                                >
                                    {isLoading ? (
